...
export const validation = yup.object().shape({
  ...
  url_en: yup.string().required("URL (EN)  is required"),
  sort_number: yup.string().required("Order number is required"),
  path_en: validateFileFieldRequired("Media field is required", "path_en"),
});
